...
COMMODITIES = {
    ...
    "Steel Flat":   {"icon":"🪛",  "fred":"PSTEELCRCOMUSDM", "fallbacks":["PSTEELCRCOMUSDM","WPU101703"], "unit":"USD/MT", "color":"#8b5cf6","group":"Steel",  "geo":"HRC prices are key benchmark. Auto & white goods sectors are main consumers.", "sources":"China, Japan, EU, South Korea"},
